     ...
     function admin() {
            ...
            $('body').on('click', '#eventgo, #eventedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "eventgo"){
                        var json = jsonreturn('/admin/eventinsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                        ...
                        var json = jsonreturn('/admin/eventUpdate',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.reload();
                        }
         ...
         this.product = function() {
            ...
            $('body').on('change', '#product_thumb', function() {
                ...
                $(this).next().val(json.url[0]);
                $(this).next().next().css('display','block');
                $(this).next().next().attr('src','http://callgettv.com/assets/uploads/'+json.url[0]);
            });
        ...
        if (json) {
          ...
          if(json.url[1]) {
            ...
            for(i = 0; i < json.url.length; i++){
              $('.youtubb').after('<img src="http://callgettv.com/assets/uploads/'+json.url[i]+'" class = "slidess">');
              $(this).next().next().css('display','block');
            }
          }
          else {
