...
<head>
	...
	<meta property="og:title" content="Callget">
	<meta name="keywords" content="갖고 싶었던 사은품! 전화 한 통으로 다 GET!" />
	<meta name="description" content="갖고 싶었던 사은품! 전화 한 통으로 다 GET!" />
	<meta property="og:description" content="갖고 싶었던 사은품! 전화 한 통으로 다 GET!">
	<meta property="og:image" content="https://callgettv.com/assets/images/ogimage.jpg">
	<meta property="og:url" content=https://callgettv.com />
...
<body id="top">
	...
	<section id="sub_banner" class="sub_banner">
		<div id="test">
			<div class="container">
				...
				<!-- <div class="w_banner">
					<a href="https://www.autoinside.co.kr/mcs/cgtv1.do">
	...
	<section id="sub_banner" class="sub_banner web">
		<div class="container">
			<div id="slider01" class="gallery-wrapper">
				<ul class="gallery-list web">
					<!-- <li><a href="https://www.autoinside.co.kr/mcs/cgtv1.do"><img src="/assets/images/banner/event_vn.png" alt="" /></a></li> -->
					<li><a href="https://callgettv.com/main/news_view/20"><img src="/assets/images/banner/event_vn2.png" alt="" /></a></li>
				</ul>
	...
	<section id="sub_banner" class="sub_banner mob">
		<div class="container">
			<div id="slider02" class="gallery-wrapper">
				<ul class="gallery-list web">
					<!-- <li><a href="https://www.autoinside.co.kr/mcs/cgtv1.do"><img src="/assets/images/banner/event_vn_m.png" alt="" /></a></li> -->
					<li><a href="https://callgettv.com/main/news_view/20"><img src="/assets/images/banner/event_vn_m2.png" alt="" /></a></li>
				</ul>
				<!-- <a class="btn-prev" href="#none">◀</a>
				<a class="btn-next" href="#none">▶</a> -->
				<div class="ctrl-box">
					...
					<? foreach ($category as $cate) : ?>
						<li class="cate_list" data-number="<?= $cate->category_idx ?>">
							<a href="javascript:void(0);">
								...
								<p id="<?= $cate->category_idx ?>"><?= $cate->category_name ?></p>
							</a>
						</li>
					<? endforeach; ?>
				</ul>
					...
					<div class="col-md-4 col-xs-6 main_list">
						<div class="product_area" onclick="location.href='<?= $row->product_numget ?><?= $row->product_idx2 ?>'">
							<div class="bg" style=" background-image: url('/assets/uploads/<?= $image ?>');">
								<div class="<?= $row->product_countcolor ?>">
									<p><?= $row->product_counttext ?></p>
									<p><?= $row->product_get ?></p>
								</div>
								<div class="contents">
									<div class="cont-area">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 p0">
					<div class="foot_cont">
						상호명 : (주)에스비제이 | 대표 : 정일웅 | 주소 : 서울특별시 강남구 논현로 149길 61 (청암빌딩) 3층 | 메일 : info@sbjgroup.co.kr | 사업자등록번호 : 894-86-01505
					</div>
				</div>
				<div class="col-xs-12">
					<div class="copyright">
