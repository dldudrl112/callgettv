...
<head>
    ...
    <title>CALLGETTV</title>

    <link href="/assets/css/bootstrap.css?<?= time(); ?>" rel="stylesheet" type="text/css">
    <link href="/assets/css/animate.css?<?= time(); ?>" rel="stylesheet" type="text/css">
    <link href="/assets/css/global.css?<?= time(); ?>" rel="stylesheet" type="text/css">
    <link href="/assets/css/get.css?<?= time(); ?>" rel="stylesheet" type="text/css">
    <link href="/assets/css/callpop.css?<?= time(); ?>" rel="stylesheet" type="text/css">
    ...
    <script>
        function gtag_report_conversion(url) {
            ...
            gtag('event', 'conversion', {
                'send_to': 'AW-675458681/xpWCCOPxg9sBEPncisIC',
    ...
    <script>
        function gtag_report_conversion(url) {
            ...
            gtag('event', 'conversion', {
                'send_to': 'AW-675458681/Sl0RCP74ktsBEPncisIC',
                'event_callback': callback
            });
            return false;
        }
